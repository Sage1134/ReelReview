...
class App(customtkinter.CTk):
    def __init__(self):
        super().__init__()
        self.winfo_toplevel().title("Reel Review")
    ...
    def pgONE(self):
        ...
        self.icon = customtkinter.CTkImage(dark_image=Image.open("Logo.png"), size=(250, 150))
    ...
    def lookupMovie(self):
        ...
        def done():
            ...
            try:
                ...
                self.outcome.configure(text=f'{text} Has No Reviews!')
        self.after(1, load)
        self.after(10, done)
